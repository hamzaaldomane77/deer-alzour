...
import type { CreateOfficeRequest } from '@/types/office';
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">إضافة مكتب جديد</h1>
            <p className="text-green-300 text-lg">أضف مكتباً أو منصباً جديداً</p>
          </div>
          <motion.button
