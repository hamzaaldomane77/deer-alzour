  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      >
        ...
        <p className="text-green-300 text-lg">نظام الإدارة العليا - وزارة الداخلية السورية</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { name: "إضافة مستخدم", icon: "➕", color: "bg-blue-500" },
              { name: "إنشاء تقرير", icon: "📊", color: "bg-green-500" },
              { name: "إعدادات النظام", icon: "⚙️", color: "bg-yellow-500" },
              { name: "النسخ الاحتياطي", icon: "💾", color: "bg-purple-500" },
            ].map((action, index) => (
              <motion.button
                key={action.name}
