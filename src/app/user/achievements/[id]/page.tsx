...
export default function AchievementDetailsPage({ params }: PageProps) {
  ...
  const fetchAchievement = async () => {
    try {
      ...
      showToast({
        ...
        message: 'فشل في تحميل تفاصيل الإنجاز',
        duration: 5000
      });
  ...
  const handleDeleteConfirm = async () => {
    try {
      setDeleting(true);
      await AchievementService.deleteAchievement(parseInt(resolvedParams.id));
      showToast({
        type: 'success',
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">تفاصيل الإنجاز</h1>
            <p className="text-green-300 text-lg">معلومات مفصلة عن إنجازك</p>
          </div>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-green-300 text-lg">{achievement.name}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  <h3 className="text-white font-bold">تاريخ الإنجاز</h3>
                  <p className="text-green-300">{formatDate(achievement.date)}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  ...
                  <p className="text-green-300">{formatDateTime(achievement.created_at)}</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <ConfirmDialog
        ...
        title="تأكيد الحذف"
        message={`هل أنت متأكد من حذف الإنجاز "${achievement?.title}"؟ لا يمكن التراجع عن هذا الإجراء.`}
        confirmText="حذف"
        cancelText="إلغاء"
        isLoading={deleting}
        type="danger"
