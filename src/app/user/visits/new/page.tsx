    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">إضافة زيارة مدنية جديدة</h1>
            <p className="text-green-300 text-lg">قم بإنشاء زيارة مدنية جديدة</p>
          </div>
          <motion.button
